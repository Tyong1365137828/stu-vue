...
module.exports = {
  ...
  output: {   //出口
    ...
    publicPath: 'dist/' //以后请求的url前面都会拼接上  'dist/'
  },  //配置好这些后,就可以在项目位置的终端输入 webpack 命令即可把main.js及其层下的各个依赖打包到指定的出口文件
  module: {
    rules: [
      {   /**配置处理css文件的loader,配置之前要注意安装 css-loader3.3.0 开发依赖包,使能够加载css样式,命令 npm install --save-dev css-loader@3.3.0
             安装 style-loader1.1.0 开发依赖包,使css样式能够添加到DOM演样式中,命令 npm install --save-dev style-loader@1.1.0
      ...
      {
        /**配置处理less文件的loader,先安装 style-loader@1.1.0版本,命令:  npm install --save-dev style-loader@1.1.0 ,再使用命令安装  npm install less-loader@4.1.0 less@3.9.0 --save-dev 注意版本问题,以此项目为准 */
        test: /\.less$/,
        use: [{     /**注意loader的引入顺序*/
      ...
      {
        /**配置ES6转为ES5的loader,使大多数浏览器能够支持,使用命令: npm install --save-dev babel-loader@7 babel-core@6.26.3 babel-preset-es2015@6.24.1*/
        test: /\.js$/,    //匹配所有.js文件
